...
::if EXIST C:\Users\Dan\Documents\Development\git\GameEngine\VS\Assets\Shaders\ (
::  copy EngineSrc\Assets\Shaders\simple_shader.vert.spv C:\Users\Dan\Documents\Development\git\GameEngine\VS\Assets\Shaders\
::  copy EngineSrc\Assets\Shaders\simple_shader.frag.spv C:\Users\Dan\Documents\Development\git\GameEngine\VS\Assets\Shaders\
::) else (
::  echo Visual Studio Project has not been created!
::)
